...
console.log( addTenAndDouble(1) );
console.log( arr.map(addTenAndDouble) );


const addTenAndDouble2 = R.pipe(add(10), multiply(2));
console.log( arr.map(addTenAndDouble2) );
...
console.log( createPerson('Chuck Norris', 'M', 45) );

console.log( createDbPerson('Chuck Norris', 'M', 45) );